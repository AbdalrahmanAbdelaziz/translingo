...
export class WordService {
  ...
  getAllWords(page: number, pageSize: number, flag: FlagEnum): Observable<ApiResponseDTO<Word[]>> {
    return this.http.get<ApiResponseDTO<Word[]>>(RANDOM_WORDS_URL(page, pageSize, flag)); 
  }
